...
function connecter()
{
    try {
        ...
        $dns = 'mysql:host=mysql.info.unicaen.fr;dbname=22008229_bd;charset=utf8';  // A compléter user_bd
        $utilisateur = '22008229';  // A compléter user
        $motDePasse = 'wahRahfut9ooRana';  // A compléter user_password
